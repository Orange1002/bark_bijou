            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <?php if ($articleCount > 0): ?>
                        <form action="doUpdateArticle.php" method="post" class="">
                            <label>標題:</label>
                            <input type="text" name="title" class="form-control mb-3" required value="<?= $row["title"] ?>">

                            <label>內容:</label>
                            <textarea name="content" class="form-control mb-3" rows="10" required><?= $row["content"] ?></textarea>
                            ...
                            <div class="dropdown mt-3">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="#">流浪專區</a></li>
                                    <li><a class="dropdown-item" href="#">商品專區</a></li>
                                    <li><a class="dropdown-item" href="#">活動專區</a></li>
                                    <li><a class="dropdown-item" href="#">教導專區</a></li>
                                </ul>
